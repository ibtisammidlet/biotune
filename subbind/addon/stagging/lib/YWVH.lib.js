...
// v2.8 
/** emulating variables
var item.SOA.name = "on";
var item.youtubeid.name = "UCm_2EwnlnnJM6wNMx1epgGQ";
var item.confperc.value = "20";
**/
//** the interval for the all script
setInterval(function(){
/** disabled()
...
function gotSOA(item) {
*/
if (/** item.SOA.name **/ "on" == "off") {
console.log("the addon is in off status");
//** showing hidden videos if there
$( "#overlays.ytd-thumbnail #progress" ).parent().parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().parent().parent().show();
$('#related #overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().parent().parent().show();
$("#playlist #overlays.ytd-thumbnail #progress").parent().parent().parent().parent().parent().parent().parent().parent().show();
$('#overlays.ytd-thumbnail #progress').parent().parent().parent().parent().parent().parent().parent().parent().show();
$('ytm-thumbnail-overlay-resume-playback-renderer .thumbnail-overlay-resume-playback-progress').parent().parent().parent().parent().parent().parent().show();
}else{
...
function gotyoutubeid(item) {
**/
window.loggedprofile = /** `${item.youtubeid.name}` **/ "@ibtisam.midlet";
/** disabled()
	}
function onError(error) {console.log(error)}
browser.storage.local.get("youtubeid")
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= /** `${item.confperc.value}` **/ "20") {$(this)/** .parent().parent().parent().parent().parent().parent().parent().hide(); **/}
})
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= /** `${item.confperc.value}` **/ "20") {$(this).parent().parent().parent().parent().parent().parent()/** +2 .parent() **/.parent().parent().hide();}
})
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= /** `${item.confperc.value}` **/ "20") {$(this).parent().parent().parent().parent().parent().parent().hide();}
})
...
$( "#related #overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= /** `${item.confperc.value}` **/ "20") {$(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().hide();}
})
console.log("hiding just the related videos");
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= /** `${item.confperc.value}` **/ "20") {$(this).parent().parent().parent().parent().parent().parent().parent().parent()/** +2 .parent() **/.parent().parent().hide();}
})
